...
import Package2.ExtentReportManager;
...
public class JoMaloneExtent1{
	...
	// @Test(priority=0)
		public void setUp()
		{
		 ExtentTest test=extent.createTest("setUp");
			try {
		...
		public void nexusChat() {
			 ...
			 ExtentTest test=extent.createTest("nexusChat");
			try {
		...
		public void WlcmMsgVerification() {
			 ExtentTest test=extent.createTest("wlcmMsgVer");
			try {
		...
		public void haveOrdNum() {
			 ExtentTest test=extent.createTest("haveOrdNum");
			 try {
		...
		public void credentials(String orderID,String email,String postCode) {
			 ExtentTest test=extent.createTest("credentials");
			try {
...
//						if(tnx_ord_info.contains("Thanks")) {
		...
		public void expFeedCon() {
			 ExtentTest test=extent.createTest("expfeedCon");
			try {
